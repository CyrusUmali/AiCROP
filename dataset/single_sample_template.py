...
generator.fill_crop_to_target(
    ...
    temp_range=(28.0, 31.0), temp_mean=29.5,
...
generator.fill_crop_to_target(
    ...
    temp_range=(25.4, 28.4), temp_mean=26.9,
...
generator.fill_crop_to_target(
    ...
    temp_range=(26.5, 29.5), temp_mean=28.0,
    moisture_range=(76.5, 91.5), moisture_mean=84,
)
...
generator.fill_crop_to_target(
    ...
    temp_range=(25.9, 28.9), temp_mean=27.4,
...
generator.fill_crop_to_target(
    ...
    temp_range=(27.7, 30.7), temp_mean=29.2,
    moisture_range=(87.5, 102.5), moisture_mean=95,
)
...
generator.fill_crop_to_target(
    ...
    temp_range=(33.1, 36.1), temp_mean=34.6,
    moisture_range=(91.5, 106.5), moisture_mean=99,
)
...
generator.fill_crop_to_target(
    ...
    temp_range=(26.5, 29.5), temp_mean=28.0,
    moisture_range=(72.5, 87.5), moisture_mean=80,
)
...
generator.fill_crop_to_target(
    ...
    temp_range=(26.8, 29.8), temp_mean=28.3,
    moisture_range=(70.5, 85.5), moisture_mean=78,
)
...
generator.fill_crop_to_target(
    ...
    temp_range=(26.6, 29.6), temp_mean=28.1,
    moisture_range=(74.5, 89.5), moisture_mean=82,
)
...
generator.fill_crop_to_target(
    ...
    temp_range=(27.4, 30.4), temp_mean=28.9,
    moisture_range=(79.5, 94.5), moisture_mean=87,
)
...
generator.fill_crop_to_target(
    ...
    temp_range=(26.3, 29.3), temp_mean=27.8,
    moisture_range=(84.5, 99.5), moisture_mean=92,
)
...
generator.fill_crop_to_target(
    ...
    temp_range=(27.5, 30.5), temp_mean=29.0,
    moisture_range=(85.5, 100.5), moisture_mean=93,
)
...
generator.fill_crop_to_target(
    ...
    temp_range=(26.4, 29.4), temp_mean=27.9,
    moisture_range=(82.5, 97.5), moisture_mean=90,
)
